...
class CalculatorEngine {
	...
	void printCalcResult(int[] datas, String result) { // 디폴트 패키지 같은 동일 패키지 안에있는 것들만 접근가능
		String oper = datas[2] == 1 ? "+" : datas[2] == 2 ? "-" : datas[2] == 3 ? "*" : datas[2] == 4 ? "/" : "%";
	...
	int[] getDatas() {
		...
		int num3 = oper.equals("+") ? 1 : oper.equals("-") ? 2 : oper.equals("*") ? 3 : oper.equals("/") ? 4 : 5;
...
//		CalculatorEngine ce = new CalculatorEngine(); // 인스턴스화
