...
public class Quiz02 {
	...
	public static void main(String[] args) {
		...
		// 1번째 사람의 이름을 입력하세요 >
		// 1번째 사람의 국어 점수를 입력하세요 >
		// 1번째 사람의 영어 점수를 입력하세요 >
		// 1번째 사람의 수학 점수를 입력하세요 >
		// ...
		// ...
		// ...
		// ...
		// 3번째 사람의 수학 점수를 입력하세요 >

		// 이름 국어 영어 수학 총점 평균
		// aaa 89 88 78 ? ?
		// bbb 89 88 78 ? ?

		int testerCount = getCount();
		...
		inputs(names, scores, totals, avgs, df);
		prints(names, scores, totals, avgs, df);
	}

	private static void prints(String[] names, int[][] scores, int[] totals, double[] avgs, DecimalFormat df) {
	...
	private static void inputs(String[] names, int[][] scores, int[] totals, double[] avgs, DecimalFormat df) {
