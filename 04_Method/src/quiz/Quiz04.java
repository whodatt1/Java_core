...
public class Quiz04 {
	...
	public static void main(String[] args) {
		// 호텔 예약 프로그램
		String[][][] makeHotel = makeHotel();
		program(makeHotel);
	}

	private static void program(String[][][] makeHotel) {
		Scanner sc = new Scanner(System.in);
		while (true) {
			System.out.println("1. 입실 , 2. 퇴실, 3. 객실 현황을 선택하여 번호를 입력하세요 > ");
	...
	private static String[][][] makeHotel() {
		Scanner sc = new Scanner(System.in);
